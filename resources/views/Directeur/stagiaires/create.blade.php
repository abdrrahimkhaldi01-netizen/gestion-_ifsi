...
@section('header')
    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200">Ajouter un stagiaire</h2>
@endsection
    ...
    <div class="max-w-2xl mx-auto px-6">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-2 mb-1">
                ...
                <span class="text-sm text-slate-600 font-medium">Ajouter</span>
            </div>
            <div class="text-xl font-bold text-slate-800 tracking-tight">Nouveau stagiaire</div>
            <div class="text-sm text-slate-500 mt-0.5">Remplissez les informations du stagiaire</div>
        </div>
        ...
        <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
            <form action="{{ route('directeur.stagiaires.store') }}"
                  method="POST"
                  autocomplete="off"
                  novalidate
                  id="form-stagiaire">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" id="nom" name="nom" value="{{ old('nom') }}"
                                       placeholder="Ex: Alaoui" maxlength="255"
                            ...
                            <div>
                                ...
                                <input type="text" id="prenom" name="prenom" value="{{ old('prenom') }}"
                                       placeholder="Ex: Youssef" maxlength="255"
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="adresse" name="adresse" value="{{ old('adresse') }}"
                                   placeholder="Ex: 12 Rue Hassan II, Casablanca" maxlength="500"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="tel" id="responsable_telephone" name="responsable_telephone"
                                       value="{{ old('responsable_telephone') }}"
                                       placeholder="06XXXXXXXX" maxlength="20"
                ...
                <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="submit" id="submit-btn"
                            ...
                            <svg id="submit-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
...
<script>
    ...
    function filterGroupes(filiereId) {
        ...
        filtered.forEach(g => {
            ...
            if (String(g.id) === String(oldGroupId)) opt.selected = true;
    ...
    // تهيئة عند تحميل الصفحة (في حالة old() بعد validation error)
    const initialFiliere = filieresSel.value;
    if (initialFiliere) {
        filterGroupes(initialFiliere);
    }
