...
<div class="flex items-center justify-between mb-6">
    <div>
        <div class="text-xl font-bold text-[#1a3a5c] tracking-tight">Mes stages</div>
        <div class="text-sm text-[#5a8aaa] mt-0.5">Liste des stages encadrés</div>
    </div>
...
<div class="bg-white border border-[#cde4f0] rounded-xl shadow-sm overflow-hidden">
    <table class="w-full border-collapse">
        <thead>
            <tr>
                @foreach(['Stagiaire','Groupe','Entreprise','Date début','Date fin','Actions'] as $th)
        ...
        <tbody>
            ...
            <tr class="hover:bg-[#f0f7fc] border-b border-slate-100 last:border-b-0 transition-colors duration-100">
                <td class="px-4 py-3 text-[13.5px] font-medium text-[#1a3a5c] whitespace-nowrap">
                ...
                <td class="px-4 py-3 text-[13.5px] text-slate-600 whitespace-nowrap">
